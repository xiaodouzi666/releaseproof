...
| Clear what / who / how description | Final Devpost story identifies enterprise data owners, the release-risk problem, the proof path, and the system architecture. | Ready |
| Qwen Cloud named in description and Built With | Qwen Cloud, Qwen 3.7 Plus, and Qwen 3.6 Flash | Ready |
| Public working deployment | [http://8.219.184.228](http://8.219.184.228) and [health](http://8.219.184.228/api/health) | Ready; HTTP only |
| Eligible entrant assertions | Submitter type, residence country, learning level, and sponsor/affiliate/government-employment declaration | Entrant input required before submission |
